...
/**
 * @case    - A buyer company views proposals targeted to them, and a publisher has targeted them in an expired proposal.
 * @expect  - The buyer should receive the defined proposal.
 * @route   - GET deals/proposals/incoming
 * @status  - working
 * @tags    - get, deals
 */
export async function ATW_API_GET_DEAPROINC_FUNC_10 (assert: test.Test) {
...
/**
 * @case    - A publisher company views proposals targeted to them, and a buyer has targeted them in a proposal with no sections.
 * @expect  - The publisher should receive the defined proposal.
 * @route   - GET deals/proposals/incoming
 * @status  - working
 * @tags    - get, deals
 */
export async function ATW_API_GET_DEAPROINC_FUNC_11 (assert: test.Test) {
...
/**
 * @case    - A buyer company views proposals targeted to them, and a publisher has targeted them in a proposal with no sections.
 * @expect  - The buyer should receive the defined proposal.
 * @route   - GET deals/proposals/incoming
 * @status  - working
 * @tags    - get, deals
 */
export async function ATW_API_GET_DEAPROINC_FUNC_12 (assert: test.Test) {
...
/**
 * @case    - A publisher company views proposals targeted to them, and a buyer has targeted them in a proposal with deleted sections.
 * @expect  - The publisher should receive the defined proposal.
 * @route   - GET deals/proposals/incoming
 * @status  - working
 * @tags    - get, deals
 */
export async function ATW_API_GET_DEAPROINC_FUNC_13 (assert: test.Test) {
...
/**
 * @case    - A buyer company views proposals targeted to them, and a publisher has targeted them in a proposal with deleted sections.
 * @expect  - The buyer should receive the defined proposal.
 * @route   - GET deals/proposals/incoming
 * @status  - working
 * @tags    - get, deals
 */
export async function ATW_API_GET_DEAPROINC_FUNC_14 (assert: test.Test) {
