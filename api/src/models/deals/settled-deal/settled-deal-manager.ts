    ...
    public async insertSettledDeal(settledDeal: SettledDealModel) {
        ...
        await this.databaseManager.transaction(async (trx) => {
            ...
            await trx.insert({
                ...
                startDate: negotiatedDeal.startDate == undefined ? '0000-00-00' : negotiatedDeal.startDate,
                endDate: negotiatedDeal.endDate == undefined ? '0000-00-00' : negotiatedDeal.endDate,
